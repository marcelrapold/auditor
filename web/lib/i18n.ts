...
export const ui = {
  ...
  de: {
    ...
    heroBadge: "DER AUDIT-ORCHESTRATOR",
    heroTitle: "Mach aus jedem KI-Agenten einen Schwarm, der Befunde beweist.",
    heroSub:
      "Ein Master-Prompt aktiviert {count} spezialisierte Prüfbereiche, lässt unabhängige Skeptiker jeden relevanten Befund angreifen und liefert nur belegte, priorisierte GitHub-Issues.",
