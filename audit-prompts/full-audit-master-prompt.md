...
`https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/CONTROL-CROSSWALK.md`). Swiss
...
```
https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/audit-prompts/<key>-audit-master-prompt.md
```
...
Fetch and follow
`https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/ISSUE-OUTPUT-STANDARD.md`. Produce, in
...
Fetch and follow
`https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/REPORT-OUTPUT-STANDARD.md`. Before
...
1. Write `auditor-out/audit-run.json` per
   `https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/schemas/audit-run.schema.json`:
...
2. Validate it: `node scripts/export-findings.mjs auditor-out/audit-run.json --validate` (the script
   ...
   `https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/scripts/export-findings.mjs`
...
Base: `https://raw.githubusercontent.com/marcelrapold/auditor/v1.0.0/`
